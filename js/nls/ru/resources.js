define({
  ...
  "user": {
    ...
    "applyEditsFailedMessage": "Произошла ошибка предоставления.",
    "applyEditsFailedRobot": "Предоставление отменено, так как не удалось обнаружить робота.",
    "applyEditsAuthError": "Ваша запись не может быть подтверждена из-за типа уровня пользователя. Обратитесь за помощью к вашему администратору.",
