define(
   ({
    ...
    user: {
      ...
      invalidLayerMessage: "Ж_A valid layer to create the GeoForm was not found. If the GeoForm has been configured with a layer, the layer may no longer be available, or authorization failed__________________________________________________Я.",
    ...
    builder: {
      ...
      submitButtonText: "Ж_Submit Button Text (Optional)__________Я",
      submitButtonDesc: "Ж_Optionally label the button to submit a new entry. This text will not be translated__________________________Я.",
      viewSubmissionsText: "Ж_View Submissions Text (Optional)___________Я",
      viewSubmissionsDesc: "Ж_Optionally label the button to view existing entries. This text will not be translated___________________________Я.",
