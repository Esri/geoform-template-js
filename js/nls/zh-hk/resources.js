define({
  ...
  "user": {
    ...
    "applyEditsFailedMessage": "發生提交錯誤。",
    "applyEditsFailedRobot": "已拒絕提交，因為它未通過機器人偵測。",
    "applyEditsAuthError": "因為您的使用者級別類型，您無法提交項目。請聯絡您的管理員以取得進一步協助。",
    ...
    "invalidLayerMessage": "找不到用來建立 GeoForm 的有效圖層。如果已使用圖層配置 GeoForm，圖層可能不再可用或授權失敗。",
  ...
  "builder": {
    ...
    "submitButtonText": "提交按鈕文字（可選）",
    "submitButtonDesc": "選擇性標示按鈕以提交新項目。不會翻譯此文字。",
    "viewSubmissionsText": "檢視提交文字（可選）",
    "viewSubmissionsDesc": "選擇性標示按鈕以檢視現有項目。不會翻譯此文字。",
    "titleText": "建構器",
    ...
    "enableOfflineSupport": "啟用離線支援",
    "enableOfflineSupportHelpText": "沒有網路連線時儲存提交，並在還原連線時提交它們。",
    "labelHelpMessage": "標籤",
