define(
   ({
    ...
    user: {
      ...
      invalidLayerMessage: "Ř_A valid layer to create the GeoForm was not found. If the GeoForm has been configured with a layer, the layer may no longer be available, or authorization failed__________________________________________________ů.",
    ...
    builder: {
      ...
      submitButtonText: "Ř_Submit Button Text (Optional)__________ů",
      submitButtonDesc: "Ř_Optionally label the button to submit a new entry. This text will not be translated__________________________ů.",
      viewSubmissionsText: "Ř_View Submissions Text (Optional)___________ů",
      viewSubmissionsDesc: "Ř_Optionally label the button to view existing entries. This text will not be translated___________________________ů.",
