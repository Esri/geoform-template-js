define({
  ...
  "user": {
    ...
    "applyEditsFailedMessage": "Nastala chyba při odesílání.",
    "applyEditsFailedRobot": "Odesílání bylo zamítnuto, protože neprošlo filtrem robotické funkce.",
    "applyEditsAuthError": "Položku nelze odeslat, protože nemáte potřebnou úroveň uživatele. Požádejte o pomoc správce vaší organizace.",
    "requiredFields": "Následující pole je povinné. Zadejte platnou hodnotu.",
    "requiredField": "(vyžadováno)",
    "error": "Chyba",
    "textRangeHintMessage": "${openStrong}Nápověda:${closeStrong} Minimální hodnota ${minValue} a Maximální hodnota ${maxValue}",
    ...
    "invalidLayerMessage": "Nebyla nalezena platná vrstva, kterou by bylo možné použít k vytvoření formuláře GeoForm. Pokud byl formulář GeoForm nakonfigurován pomocí vrstvy, tato vrstva již nemusí být k dispozici, nebo selhala autorizace.",
  ...
  "builder": {
    ...
    "invalidWebmapSelectionAlert2": "Další informace naleznete v části ${openLink}Co je Feature služba?${closeLink}",
    ...
    "submitButtonText": "Text tlačítka Odeslat (volitelné)",
    "submitButtonDesc": "Volitelně můžete označit tlačítko sloužící k odeslání nové položky. Toto označení nebude přeloženo.",
    "viewSubmissionsText": "Text tlačítka Zobrazení podaného příspěvku (volitelné)",
    "viewSubmissionsDesc": "Volitelně můžete označit tlačítko sloužící k zobrazení existujících položek. Toto označení nebude přeloženo.",
    ...
    "layerTabText": "Z těchto vrstev bude vytvořen formulář GeoForm. Tyto vrstvy musí být typu Feature služba s povolenými možnostmi úprav a oprávněními pro sdílení vhodnými pro vaše uživatele. Pokud jsou vybrány všechny vrstvy, dovolí formulář uživateli vybrat, do které vrstvy formuláře budou data odeslána.",
    ...
    "enableOfflineSupport": "Povolit režim offline",
    "enableOfflineSupportHelpText": "Pokud není k dispozici připojení k síti, odeslané položky se uloží a odešlou se po obnovení připojení.",
