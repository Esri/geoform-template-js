define(
   ({
    ...
    user: {
      ...
      invalidLayerMessage: "ķ_A valid layer to create the GeoForm was not found. If the GeoForm has been configured with a layer, the layer may no longer be available, or authorization failed__________________________________________________ū.",
    ...
    builder: {
      ...
      submitButtonText: "ķ_Submit Button Text (Optional)__________ū",
      submitButtonDesc: "ķ_Optionally label the button to submit a new entry. This text will not be translated__________________________ū.",
      viewSubmissionsText: "ķ_View Submissions Text (Optional)___________ū",
      viewSubmissionsDesc: "ķ_Optionally label the button to view existing entries. This text will not be translated___________________________ū.",
      titleText: "Veidotājs",
