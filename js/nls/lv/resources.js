define({
  ...
  "user": {
    ...
    "locationInformationText": "${formSection} Izvēlēties novietojumu",
    "submitInformationText": "${formSection} Aizpildīt formu",
    "submitInstructions": "Pievienot šo informāciju kartei.",
    "myLocationText": "Pašreizējais novietojums",
    "locationDescriptionForMoreThanOneOption": "Norādiet šī ieraksta novietojumu, noklikšķinot/pieskaroties kartei vai izmantojot kādu no tālāk norādītajām opcijām.",
    "locationDescriptionForOneOption": "Norādiet šī ieraksta novietojumu, noklikšķinot/pieskaroties kartei, vai izmantojot tālāk norādīto opciju.",
    "locationDescriptionForNoOption": "Norādiet šī ieraksta novietojumu, noklikšķinot/pieskaroties kartei.",
    "addressText": "Meklēt",
    "geographic": "Plat./gar.",
    "locationTabText": "Novietojums",
    "locationPopupTitle": "Novietojums",
    ...
    "selectLocation": "Lūdzu, izvēlieties iesniegšanas novietojumu.",
    ...
    "shareUserTextMessage": "Aiciniet arī citus iesaistīties, izvēloties kādu no sekojošajām opcijām.",
    ...
    "close": "Aizvērt",
    "locationNotFound": "Novietojumu nevarēja atrast.",
    ...
    "applyEditsFailedMessage": "Radās iesniegšanas kļūda.",
    "applyEditsFailedRobot": "Iesniegšana tika noraidīta, jo robotam to neizdevās noteikt.",
    "applyEditsAuthError": "Jūsu ierakstu nevar iesniegt jūsu lietotāja līmeņa veida dēļ. Sazinieties ar organizācijas administratoru, lai iegūtu tālāku palīdzību.",
    ...
    "invalidLayerMessage": "GeoForm izveidei derīgs slānis netika atrasts. Ja GeoForm konfigurācijā tika izmantots slānis, iespējams, slānis vairs nav pieejams vai neizdevās autorizācija.",
  ...
  "builder": {
    ...
    "submitButtonText": "Iesniegšanas pogas teksts (pēc izvēles)",
    "submitButtonDesc": "Pēc izvēles pievienojiet tekstu pogai, kas paredzēta jauna ieraksta iesniegšanai. Šis teksts netiks tulkots.",
    "viewSubmissionsText": "Iesniegto vienību skatīšanas teksts (pēc izvēles)",
    "viewSubmissionsDesc": "Pēc izvēles pievienojiet tekstu pogai, kas paredzēta esošo ierakstu skatīšanai. Šis teksts netiks tulkots.",
    "titleText": "Veidotājs",
    ...
    "viewWebmap": "Skatīt tīmekļa karti",
    ...
    "shareBuilderTitleMessage": "Vienība sekmīgi saglabāta",
    ...
    "detailsTabText": "Izmantojiet tālāk esošos veidlapas informācijas lodziņus, lai pielāgotu virsrakstu un pievienotu pielāgotu logotipu, kā arī sniedziet īsu aprakstu, kas paredzēts jūsu GeoForm auditorijai. Aprakstā varat pievienot saites uz citiem resursiem, kontaktinformāciju, kā arī novirzīt savu auditoriju uz tīmekļa lietotni, kurā ir pieejami visi dati, kas apkopoti, izmantojot GeoForm.",
    ...
    "fieldTabPlaceHolderHeaderText": "Norāde (pēc izvēles)",
    ...
    "defaultMapExtentDescription": "Pēc iesniegšanas jūsu tīmekļa kartē tiks atiestatīts noklusējuma pārklājums (to var atspējot jebkurā laikā).",
    ...
    "selectLocationText": "Atlasīt novietojumu pēc",
    "myLocationText": "Mans novietojums",
    "searchText": "Meklēt",
    "coordinatesText": "Platuma un garuma koordinātas",
    "usng": "USNG koordinātas",
    "mgrs": "MGRS koordinātas",
    "utm": "UTM koordinātas",
    "selectLocationSDescription": "Atļaut lietotājiem atlasīt novietojumu, izmantojot šīs metodes.",
    ...
    "enableOfflineSupport": "Iespējot bezsaistes atbalstu",
    "enableOfflineSupportHelpText": "Glabājiet iesniegtās vienības, ja nav savienojuma ar tīklu, un iesniedziet tās pēc savienojuma atjaunošanas.",
