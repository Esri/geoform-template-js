define(
   ({
    ...
    user: {
      ...
      invalidLayerMessage: "Å_A valid layer to create the GeoForm was not found. If the GeoForm has been configured with a layer, the layer may no longer be available, or authorization failed__________________________________________________ö.",
    ...
    builder: {
      ...
      submitButtonText: "Å_Submit Button Text (Optional)__________ö",
      submitButtonDesc: "Å_Optionally label the button to submit a new entry. This text will not be translated__________________________ö.",
      viewSubmissionsText: "Å_View Submissions Text (Optional)___________ö",
      viewSubmissionsDesc: "Å_Optionally label the button to view existing entries. This text will not be translated___________________________ö.",
