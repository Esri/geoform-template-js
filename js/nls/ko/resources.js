define({
  ...
  "user": {
    ...
    "applyEditsFailedMessage": "제출 오류가 발생했습니다.",
    "applyEditsFailedRobot": "본인 인증 감지에 실패하여 제출이 거부되었습니다.",
    "applyEditsAuthError": "사용자 레벨 유형으로 인해 항목을 제출할 수 없습니다. 추가 도움이 필요한 경우 내 기관의 관리자에게 문의하세요.",
    ...
    "invalidLayerMessage": "GeoForm을 생성할 올바른 레이어가 없습니다. GeoForm이 레이어로 구성되어 있다면 해당 레이어를 더 이상 사용할 수 없거나 인증에 실패한 것입니다.",
  ...
  "builder": {
    ...
    "submitButtonText": "제출 버튼 텍스트(선택 사항)",
    "submitButtonDesc": "필요한 경우 새 항목을 제출할 버튼의 레이블을 지정합니다. 이 텍스트는 번역되지 않습니다.",
    "viewSubmissionsText": "제출 내역 보기 텍스트(선택 사항)",
    "viewSubmissionsDesc": "필요한 경우 기존 항목을 표시할 버튼의 레이블을 지정합니다. 이 텍스트는 번역되지 않습니다.",
    "titleText": "빌더",
    ...
    "enableOfflineSupport": "오프라인 지원 활성화",
    "enableOfflineSupportHelpText": "네트워크 연결이 불가능 한 경우 제출 내역을 저장한 후 연결이 복구되면 제출합니다.",
