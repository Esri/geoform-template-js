define(
   ({
    ...
    user: {
      ...
      invalidLayerMessage: "한_A valid layer to create the GeoForm was not found. If the GeoForm has been configured with a layer, the layer may no longer be available, or authorization failed__________________________________________________빠.",
    ...
    builder: {
      ...
      submitButtonText: "한_Submit Button Text (Optional)__________빠",
      submitButtonDesc: "한_Optionally label the button to submit a new entry. This text will not be translated__________________________빠.",
      viewSubmissionsText: "한_View Submissions Text (Optional)___________빠",
      viewSubmissionsDesc: "한_Optionally label the button to view existing entries. This text will not be translated___________________________빠.",
      titleText: "빌더",
