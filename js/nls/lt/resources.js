define(
   ({
    ...
    user: {
      ...
      invalidLayerMessage: "Į_A valid layer to create the GeoForm was not found. If the GeoForm has been configured with a layer, the layer may no longer be available, or authorization failed__________________________________________________š.",
    ...
    builder: {
      ...
      submitButtonText: "Į_Submit Button Text (Optional)__________š",
      submitButtonDesc: "Į_Optionally label the button to submit a new entry. This text will not be translated__________________________š.",
      viewSubmissionsText: "Į_View Submissions Text (Optional)___________š",
      viewSubmissionsDesc: "Į_Optionally label the button to view existing entries. This text will not be translated___________________________š.",
