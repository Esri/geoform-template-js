define({
  ...
  "builder": {
    ...
    "enableBasemapToggleDescription": "Konfigūruokite Geoformą pagrindinio žemėlapio perjungiklio rodymui / slėpimui",
    ...
    "geoformTitleText": "Geoforma",
    "layerTabText": "Tai sluoksnis (-iai), iš kurio (-ių) bus sukurta Geoforma. Šis sluoksnis turi būti elementų paslauga, įgalinta redaguoti naudojant Jūsų auditorijai tinkamą bendrinimo teisę. Jei pasirinkti visi sluoksniai, forma leis vartotojui pasirinkti, į kurį formos sluoksnį pateikti.",
    "detailsTabText": "Naudokite žemiau esančius formos išsamios informacijos laukus – adaptuokite pavadinimą, pridėkite adaptuotą logotipą ir pateikite trumpą aprašą auditorijai naudosiančiai Geoformą. Aprašyme galite pridėti nuorodų į kitus šaltinius, kontaktinę informaciją ir netgi nukreipti auditoriją į interneto žemėlapių aplikaciją, kurioje yra publikuojami duomenys, surinkti naudojant Geoformą.",
    ...
    "publishTabText": "Jei baigėte adaptuoti Geoformą, įrašykite pateiktį ir pradėkite bendrinti su auditorija. Visada galėsite grįžti į šią kūrimo priemonę ir toliau adaptuoti remdamiesi atsiliepimais.",
    ...
    "shareDescription": "Bendrinimo socialinėje žiniasklaidoje mygtukai leidžia jūsų auditorijai lengvai bendrinti Geoformą (po to, kai ji atliks pateikimą)",
