define({
  ...
  "user": {
    ...
    "noLayerConfiguredMessage": "אירעה שגיאה בטעינה או באיתור של שכבת ישויות הניתנת לעריכה. כדי להציג את הטופס ולהתחיל לאסוף מסירות, הוסף ל- Webmap שכבת ישויות הניתנת לעריכה.",
    ...
    "applyEditsFailedMessage": "אירעה שגיאת מסירה.",
    "applyEditsFailedRobot": "המסירה נדחתה עקב כישלון בבדיקה לזיהוי רובוטים.",
    "applyEditsAuthError": "הרשומה שלך לא הוזנה עקב סוג רמת המשתמש שלך. פנה למנהל המערכת של ארגונך לקבלת סיוע נוסף.",
    ...
    "invalidLayerMessage": "לא נמצאה שכבה חוקית ליצירת ה-GeoForm. אם ה-GeoForm הוגדר עם שכבה, ייתכן שהשכבה לא תהיה זמינה עוד, או שהאישור נכשל.",
  ...
  "builder": {
    ...
    "invalidWebmapSelectionAlert": "מפת האינטרנט שנבחרה אינה מכילה שכבה חוקית לשימוש. הוסף ל-Webmap שכבת ישויות הניתנת לעריכה כדי שתוכל להמשיך.",
    ...
    "submitButtonText": "טקסט לחצן 'טען' (אופציונלי)",
    "submitButtonDesc": "באפשרותך להוסיף תווית ללחצן כדי לטעון רשומה חדשה. טקסט זה לא יתורגם.",
    "viewSubmissionsText": "הצג הזנות טקסט (אופציונלי)",
    "viewSubmissionsDesc": "באפשרותך להוסיף תווית ללחצן כדי להציג רשומות קיימות. טקסט זה לא יתורגם.",
    "titleText": "אשף בנייה",
    ...
    "enableOfflineSupport": "הפוך תמיכה לא מקוונת לפעילה",
    "enableOfflineSupportHelpText": "אחסן הזנות כאשר אין חיבור רשת והזן אותן כאשר החיבור משוחזר",
