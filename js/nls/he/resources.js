define(
   ({
    ...
    user: {
      ...
      invalidLayerMessage: "כן_A valid layer to create the GeoForm was not found. If the GeoForm has been configured with a layer, the layer may no longer be available, or authorization failed__________________________________________________ש.",
    ...
    builder: {
      ...
      submitButtonText: "כן_Submit Button Text (Optional)__________ש",
      submitButtonDesc: "כן_Optionally label the button to submit a new entry. This text will not be translated__________________________ש.",
      viewSubmissionsText: "כן_View Submissions Text (Optional)___________ש",
      viewSubmissionsDesc: "כן_Optionally label the button to view existing entries. This text will not be translated___________________________ש.",
      titleText: "אשף בנייה",
