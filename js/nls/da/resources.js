define({
  ...
  "user": {
    ...
    "applyEditsFailedMessage": "Der opstod en fejl under afsendelse.",
    "applyEditsFailedRobot": "Afsendelse blev afvist, fordi robotregistrering mislykkedes.",
    "applyEditsAuthError": "Din post kan ikke afsendes på grund af din brugerniveautype. Kontakt din organisations administrator for yderligere assistance.",
    ...
    "invalidLayerMessage": "Et gyldigt lag til oprettelse af GeoForm’en blev ikke fundet. Hvis GeoForm’en er blevet konfigureret med et lag, er laget muligvis ikke længere tilgængeligt, eller autorisationen mislykkedes.",
  ...
  "builder": {
    ...
    "submitButtonText": "Send-knaptekst (valgfri)",
    "submitButtonDesc": "Det er valgfrit at mærke den knap, der afsender en ny post. Denne tekst vil ikke blive oversat.",
    "viewSubmissionsText": "Vis afsendelser-tekst (valgfri)",
    "viewSubmissionsDesc": "Det er valgfrit at mærke den knap, der viser eksisterende poster. Denne tekst vil ikke blive oversat.",
    "titleText": "Builder",
    ...
    "enableOfflineSupport": "Aktivér offline-understøttelse.",
    "enableOfflineSupportHelpText": "Gem afsendelser, når der ikke er netværksforbindelse, og send dem, når netværksforbindelsen gendannes.",
