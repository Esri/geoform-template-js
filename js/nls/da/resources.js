define(
   ({
    ...
    user: {
      ...
      invalidLayerMessage: "ø_A valid layer to create the GeoForm was not found. If the GeoForm has been configured with a layer, the layer may no longer be available, or authorization failed__________________________________________________å.",
    ...
    builder: {
      ...
      submitButtonText: "ø_Submit Button Text (Optional)__________å",
      submitButtonDesc: "ø_Optionally label the button to submit a new entry. This text will not be translated__________________________å.",
      viewSubmissionsText: "ø_View Submissions Text (Optional)___________å",
      viewSubmissionsDesc: "ø_Optionally label the button to view existing entries. This text will not be translated___________________________å.",
      titleText: "Builder",
