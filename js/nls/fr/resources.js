define({
  ...
  "user": {
    ...
    "applyEditsFailedMessage": "Une erreur de soumission s'est produite.",
    "applyEditsFailedRobot": "La soumission a été rejetée car elle a échoué au test de détection de robot.",
    "applyEditsAuthError": "Votre entrée ne peut pas être soumise en raison de votre type de niveau d'utilisateur. Veuillez contacter l'administrateur de votre organisation pour obtenir de l'aide.",
    ...
    "invalidLayerMessage": "Impossible de trouver une couche valide pour créer le formulaire géographique. Si le formulaire géographique a été configuré avec une couche, cette couche n'est peut-être plus disponible ou l'autorisation a échoué.",
  ...
  "builder": {
    ...
    "submitButtonText": "Texte du bouton Envoyer (facultatif)",
    "submitButtonDesc": "Vous pouvez donner un nom au bouton pour soumettre une nouvelle entrée. Ce texte n'est pas traduit.",
    "viewSubmissionsText": "Texte Afficher les envois (facultatif)",
    "viewSubmissionsDesc": "Vous pouvez donner un nom au bouton pour afficher les entrées existantes. Ce texte n'est pas traduit.",
    ...
    "enableOfflineSupport": "Activer le support hors connexion",
    "enableOfflineSupportHelpText": "Stockez les envois lorsqu'il n'y a pas de connexion réseau et envoyez-les lorsque la connexion est restaurée.",
