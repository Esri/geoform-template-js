define({
  ...
  "user": {
    ...
    "applyEditsFailedMessage": "มีข้อผิดพลาดเกิดขึ้นในการส่ง",
    "applyEditsFailedRobot": "ส่งถูกปฏิเสธเพราะมันล้มเหลวในการตรวจสอบหุ่นยนต์",
    "applyEditsAuthError": "รายการของคุณไม่สามารถส่งเนื่องจากประเภทระดับผู้ใช้ของคุณ กรุณาติดต่อผู้ดูแลองค์กรของคุณสำหรับความช่วยเหลือเพิ่มเติม",
    ...
    "invalidLayerMessage": "ไม่พบชั้นข้อมูลที่ถูกต้องในการสร้าง GeoForm หาก GeoForm ได้รับการกำหนดค่าด้วยชั้นข้อมูล ชั้นข้อมูลนี้อาจไม่สามารถใช้ได้",
  ...
  "builder": {
    ...
    "submitButtonText": "ปุ่มส่งข้อความ (ตัวเลือก)",
    "submitButtonDesc": "เลือกป้ายปุ่มเพื่อส่งรายการใหม่ ข้อความนี้จะไม่ได้รับการแปล",
    "viewSubmissionsText": "แสดงข้อมูความที่ส่งไป (ตัวเลือก)",
    "viewSubmissionsDesc": "เลือกปุ่มเพื่อดูรายการที่มีอยู่ ข้อความนี้จะไม่ได้รับการแปล",
    "titleText": "Builder",
    ...
    "enableOfflineSupport": "เปิดใช้การทำงานแบบออฟไลน์",
    "enableOfflineSupportHelpText": "ส่งกลับเมื่อมีการเชื่อมต่อเครือข่ายและส่งพวกเขาเมื่อมีการเชื่อมต่อจะถูกเชื่อมต่ออีกครั้ง",
