define({
  ...
  "user": {
    ...
    "applyEditsFailedMessage": "Ett insändningsfel uppstod.",
    "applyEditsFailedRobot": "Insändningen misslyckades eftersom robotspårningen misslyckades.",
    "applyEditsAuthError": "Ditt bidrag kan inte skickas beroende på din typ av användarnivå. Kontakta organisationsadministratören om du behöver hjälp.",
