define({
  ...
  "user": {
    ...
    "applyEditsFailedMessage": "Er is een verzendingsfout opgetreden.",
    "applyEditsFailedRobot": "De verzending werd geweigerd omdat ze niet slaagde voor de robotdetectie.",
    "applyEditsAuthError": "Uw invoer kan niet verzonden worden omwille van uw gebruikersniveautype. Neem contact op met de beheerder van uw organisatie voor verdere assistentie.",
    ...
    "invalidLayerMessage": "Er is geen geldige laag gevonden om de GeoForm te maken. Als de GeoForm is geconfigureerd met een laag, dan is de laag niet meer beschikbaar of de autorisatie is mislukt.",
  ...
  "builder": {
    ...
    "submitButtonText": "Tekst verzendknop (optioneel)",
    "submitButtonDesc": "Label de knop optioneel voor een nieuwe invoer. Deze tekst wordt niet vertaald.",
    "viewSubmissionsText": "Tekstinzendingen bekijken (optioneel)",
    "viewSubmissionsDesc": "Label de knop optioneel om bestaande invoer te bekijken. Deze tekst wordt niet vertaald.",
    "titleText": "Builder",
    ...
    "enableOfflineSupport": "Offline ondersteuning inschakelen",
    "enableOfflineSupportHelpText": "Sla de inzendingen op als er geen netwerkverbinding is en dien ze in als de verbinding is hersteld.",
