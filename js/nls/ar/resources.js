define(
   ({
    ...
    user: {
      ...
      invalidLayerMessage: "بيت_A valid layer to create the GeoForm was not found. If the GeoForm has been configured with a layer, the layer may no longer be available, or authorization failed__________________________________________________لاحقة.",
    ...
    builder: {
      ...
      submitButtonText: "بيت_Submit Button Text (Optional)__________لاحقة",
      submitButtonDesc: "بيت_Optionally label the button to submit a new entry. This text will not be translated__________________________لاحقة.",
      viewSubmissionsText: "بيت_View Submissions Text (Optional)___________لاحقة",
      viewSubmissionsDesc: "بيت_Optionally label the button to view existing entries. This text will not be translated___________________________لاحقة.",
      titleText: "مُنشئ",
