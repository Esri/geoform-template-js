define({
  ...
  "user": {
    ...
    "applyEditsFailedMessage": "حدث خطأ في الإرسال",
    "applyEditsFailedRobot": "تم رفض الإرسال نظرًا لأنه فشل عملية الاكتشاف الآلية.",
    "applyEditsAuthError": "يتعذر تقديم الإدخال الخاص بك نظرًا لنوع مستوى المستخدم. الرجاء الاتصال بمسئول المؤسسة للحصول على مزيد من المساعدة.",
