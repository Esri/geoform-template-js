define(
   ({
    ...
    user: {
      ...
      invalidLayerMessage: "å_A valid layer to create the GeoForm was not found. If the GeoForm has been configured with a layer, the layer may no longer be available, or authorization failed__________________________________________________ø.",
    ...
    builder: {
      ...
      submitButtonText: "å_Submit Button Text (Optional)__________ø",
      submitButtonDesc: "å_Optionally label the button to submit a new entry. This text will not be translated__________________________ø.",
      viewSubmissionsText: "å_View Submissions Text (Optional)___________ø",
      viewSubmissionsDesc: "å_Optionally label the button to view existing entries. This text will not be translated___________________________ø.",
