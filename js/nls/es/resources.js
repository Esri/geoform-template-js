define(
     ({
        ...
        builder: {
            ...
            titleText: "Builder",
            descriptionText: "El formulario geográfico es una plantilla configurable para la edición de los datos basados en formularios de un ${link1}servicio de entidades${closeLink}. Esta aplicación permite a los usuarios introducir datos por medio de un formulario en lugar de hacerlo con una ventana emergente del mapa, aprovechando así la eficacia del ${link2}mapa web${closeLink} y los servicios de entidades editables. Sigue estos pasos para personalizar e implementar tu formulario geográfico.",
            ...
            attachmentHint: "Si es necesario, puedes aportar instrucciones adicionales sobre los anexos aquí.",
