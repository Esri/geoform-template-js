define({
  ...
  "user": {
    ...
    "applyEditsFailedMessage": "Ha ocurrido un error de envío.",
    "applyEditsFailedRobot": "El envío se ha rechazado porque la detección de robots ha fallado.",
    "applyEditsAuthError": "Su entrada no se puede enviar debido al tipo de nivel de usuario. Póngase en contacto con su administrador de la organización para obtener más ayuda.",
    ...
    "invalidLayerMessage": "No se encontró ninguna capa válida para crear el GeoForm. Si el GeoForm se ha configurado con una capa, puede que esta ya no esté disponible o que la autorización haya fallado.",
  ...
  "builder": {
    ...
    "submitButtonText": "Texto del botón Enviar (opcional)",
    "submitButtonDesc": "Etiqueta opcional del botón para enviar una entrada nueva. Este texto no se traducirá.",
    "viewSubmissionsText": "Texto de Ver envíos (opcional)",
    "viewSubmissionsDesc": "Etiqueta opcional del botón para ver entradas existentes. Este texto no se traducirá.",
    "titleText": "Builder",
    ...
    "enableOfflineSupport": "Habilitar compatibilidad sin conexión",
    "enableOfflineSupportHelpText": "Almacena los envíos cuando no hay conexión de red y los envía cuando se restaura la conexión.",
