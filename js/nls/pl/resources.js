define({
  ...
  "user": {
    ...
    "applyEditsFailedMessage": "Wystąpił błąd przesyłania.",
    "applyEditsFailedRobot": "Odrzucono operację przesyłania, ponieważ nie przeszła ona pomyślnie procedury wykrywania robotów.",
    "applyEditsAuthError": "Nie można przesłać wpisu z powodu Twojego typu poziomu użytkownika. Aby uzyskać dalszą pomoc, skontaktuj się z administratorem Twojej instytucji.",
    ...
    "invalidLayerMessage": "Nie znaleziono prawidłowej warstwy w celu utworzenia Formularza geograficznego. Jeśli Formularz geograficzny został skonfigurowany z warstwą, ta warstwa może być niedostępna lub autoryzacja nie powiodła się.",
  ...
  "builder": {
    ...
    "submitButtonText": "Tekst przycisku Prześlij (opcjonalny)",
    "submitButtonDesc": "Opcjonalnie zdefiniuj etykietę przycisku do przesyłania nowego wpisu. Ten tekst nie będzie tłumaczony.",
    "viewSubmissionsText": "Tekst przycisku Wyświetl zgłoszenia (opcjonalny)",
    "viewSubmissionsDesc": "Opcjonalnie zdefiniuj etykietę przycisku do wyświetlania istniejących wpisów. Ten tekst nie będzie tłumaczony.",
    "titleText": "Kreator",
    ...
    "enableOfflineSupport": "Włącz obsługę w trybie offline",
    "enableOfflineSupportHelpText": "Zapisuje zgłoszenia, kiedy nie ma połączenia z siecią, i przesyła je po przywróceniu połączenia.",
