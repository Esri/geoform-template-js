define(
     ({
        ...
        user: {
            ...
            locationDescription: "Wybierz lokalizację dla tego obiektu poprzez kliknięcie/dotknięcie mapy lub za pomocą jednej z następujących opcji.",
            ...
            selectLocation: "Wybierz ${openLink}lokalizację${closeLink} do wysłania.",
            ...
            invalidLatLong: "Wprowadź poprawne współrzędne ${latLink}szerokości geograficznej${closeLink} i ${lngLink}długości geograficznej${closeLink}.",
            invalidUTM: "Wprowadź poprawne współrzędne ${openLink}UTM${closeLink}.",
            invalidUSNG: "Wprowadź poprawne współrzędne ${openLink}USNG${closeLink}.",
            invalidMGRS: "Wprowadź poprawne współrzędne ${openLink}MGRS${closeLink}.",
        ...
        builder: {
            ...
            descriptionLabelText: "Tekst pomocy (opcjonalny)",
            ...
            pushpinText: "Pinezka",
            doneButtonText: "Wyświetl element aplikacji",
            fieldTabPlaceHolderHeaderText: "Wskazówka (opcjonalna)",
            attachmentLabelText: "Etykieta załącznika",
            attachmentLabelHint: "Powiedz użytkownikom, jaki rodzaj pliku mają załączyć.",
            ...
            jumbotronDescription: "Bootstrap Jumbotron ułatwia określanie celu aplikacji. Opcję tę można w każdej chwili wyłączyć.",
