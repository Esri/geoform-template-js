define({
  ...
  "user": {
    ...
    "applyEditsFailedMessage": "Đã xảy ra lỗi gửi.",
    "applyEditsFailedRobot": "Thao tác gửi đã bị từ chối do không thể phát hiện người máy.",
    "applyEditsAuthError": "Không thể gửi mục nhập của bạn do loại cấp độ người dùng. Vui lòng liên hệ với người quản trị tổ chức của bạn để được hỗ trợ thêm.",
